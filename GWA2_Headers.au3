...
;Currently unused, no idea maybe from some custom functions
;@TODO Implement Item Buy / Sell Function
Global Const $HEADER_ITEM_SELL				= 0x4A	;Sells item to merchant
Global Const $HEADER_ITEM_BUY				= 0x4D	;Buys item from merchant
